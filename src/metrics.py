...
class BalancedAccuracyPluginMetric(GenericPluginMetric[float, BalancedAccuracy]):
    """
...
class SensitivityPluginMetric(GenericPluginMetric[float, Sensitivity]):
    """
...
class SpecificityPluginMetric(GenericPluginMetric[float, Specificity]):
    """
...
class PrecisionPluginMetric(GenericPluginMetric[float, Precision]):
    """
...
class AUPRCPluginMetric(GenericPluginMetric[float, AUPRC]):
    """
...
class ROCAUCPluginMetric(GenericPluginMetric[float, ROCAUC]):
    """
